...
* Just install in your Xamarin.Forms PCL/.NET Net Standard  project, you're good go! (no need to install in the platform projects) because it's that awesome and lightweight! :D 
